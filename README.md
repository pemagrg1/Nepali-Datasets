...
* **Nepse-Floorsheet** ✓- Comprehensive historical floorsheet data (2014/05/05 to 2026/04/21)  [Kaggle:viking303/nepse-historical-floorsheet](https://www.kaggle.com/datasets/viking303/nepse-historical-floorsheet)
* **Nepse-Data** ✓ - Comprehensive (OHLCV + total traded shares) (updates everyday))[Github:Aabishkar2/nepse-data](https://github.com/Aabishkar2/nepse-data)
* 
